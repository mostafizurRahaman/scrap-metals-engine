import z from "zod"
        ...
        export type TCreateConversationUserPayloadType = z.infer<typeof createConversationUserSchema.shape.body>
        export type TUpdateConversationUserPayloadType = z.infer<typeof updateConversationUserSchema.shape.body>
        export type TGetAllConversationUserQueryParamsType = z.infer<typeof getAllConversationUserSchema.shape.query>
        export type TGetConversationUserByIdParamsType = z.infer<typeof getConversationUserByIdSchema.shape.params>
        export type TDeleteConversationUserByIdParamsType = z.infer<typeof deleteConversationUserByIdSchema.shape.params>